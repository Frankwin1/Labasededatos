package com.example.labasededatos;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void Registrar(View view){
        ...
        SQLiteDatabase BaseDeDatosdos = admin.getWritableDatabase();
        ...
        if(!codigo.isEmpty() && !descripcion.isEmpty() && !precio.isEmpty()){
          ...
          BaseDeDatosdos.insert("articulos",null,registro);
          BaseDeDatosdos.close();
          et_codigo.setText("");
          ...
          Toast.makeText(this,"Registro Exitoso",Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(this,"Tienes que llenar todos los campos del formulario",Toast.LENGTH_SHORT).show();
        }
    }
   ...
   //Metodo para eliminar artículo o producto
    ...
    //Metodo para modificar un artículo o producto
    public void Modificar(View view){
        AdminSQLiteOpenHelper admin = new AdminSQLiteOpenHelper(this,"administracion",null,1);
        SQLiteDatabase BaseModificar = admin.getWritableDatabase();
        String codigo = et_codigo.getText().toString();
        String descripcion = et_descripcion.getText().toString();
        String precio = et_precio.getText().toString();
        if(!codigo.isEmpty() && !descripcion.isEmpty() && !precio.isEmpty()){
            ...
            registro.put("descripcion",descripcion);
            registro.put("precio", precio);
            int cantidad =BaseModificar.update("articulos",registro,"codigo=" + codigo,null);
            BaseModificar.close();
            if(cantidad ==1){
